...
namespace ReadingsBuilder.Data.Rules
{
    ...
    public enum ColumnIndexes
    {
        ...
        RclTrack1ShortNameOverride,
        RclTrack1FullNameOverride,
        RclTrack1Note,
        RclTrack1Other,
        RclTrack1Apocryphal,
        ...
        RclTrack2ShortNameOverride,
        RclTrack2FullNameOverride,
        RclTrack2Note,
        RclTrack2Other,
        RclTrack2Apocryphal,
        ...
        RclTrack3ShortNameOverride,
        RclTrack3FullNameOverride,
        RclTrack3Note,
        RclTrack3Other,
        RclTrack3Apocryphal,
        RclTrack3OldTestament,
        RclTrack3OldTestamentAlternative,
        RclTrack3Psalm,
        RclTrack3PsalmAlternative,
        RclTrack3Canticle,
        RclTrack3ApocryphalCanticle,
        RclTrack3NewTestament,
        RclTrack3NewTestamentAlternative,
        RclTrack3Gospel,
        RclTrack3GospelAlternative
    }
        ...
        public List<Rule> MapRowsToRules(List<List<string>> rows)
        {
            ...
            foreach (var row in rows)
            {
                ...
                var rule = new Rule()
                {
                    ...
                    RclTrack1ShortNameOverride = GetValueOrNull(row, ColumnIndexes.RclTrack1ShortNameOverride),
                    RclTrack1FullNameOverride = GetValueOrNull(row, ColumnIndexes.RclTrack1FullNameOverride),
                    RclTrack1Note = GetValueOrNull(row, ColumnIndexes.RclTrack1Note),
                    ...
                    RclTrack2ShortNameOverride = GetValueOrNull(row, ColumnIndexes.RclTrack2ShortNameOverride),
                    RclTrack2FullNameOverride = GetValueOrNull(row, ColumnIndexes.RclTrack2FullNameOverride),
                    RclTrack2Note = GetValueOrNull(row, ColumnIndexes.RclTrack2Note),
                    RclTrack2Psalm = GetValueOrNull(row, ColumnIndexes.RclTrack2Psalm),
                    RclTrack2Canticle = GetValueOrNull(row, ColumnIndexes.RclTrack2Canticle),
